...
.attr('x1',0).attr('x2',161,5).style('stroke','red');
height_male.append('circle').attr('cx',161.5).attr('cy',100).attr('r',3);
height_male.append('text').attr('x',0).attr('y',150).text("台灣女生平均身高161.5 cm");